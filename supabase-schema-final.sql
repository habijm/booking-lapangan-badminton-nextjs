-- ================================================================
-- BADMINTON BOOKING SYSTEM — FINAL SCHEMA v3
-- Jalankan SEKALI di Supabase SQL Editor pada project baru.
-- Jika sudah punya data, gunakan migration-courts.sql dan
-- migration-settings.sql yang terpisah.
-- ================================================================
...
-- Drop old policies (safe to rerun)
DO $$ DECLARE r RECORD;
BEGIN
...
--
-- 1. Buat admin user di: Supabase > Authentication > Users > Add User
--
-- 2. Catat User ID dari hasil langkah 1, lalu jalankan:
--    INSERT INTO user_roles (user_id, role)
--    VALUES ('<paste-user-id-di-sini>', 'superadmin');
--
-- 3. Isi .env.local sesuai .env.example
--
-- 4. npm run dev → login di /admin → buka /admin/settings
--    untuk mengisi nama GOR, nomor WA, harga, dll.
-- ================================================================
